...
const Stats = () => {
  return (
    <div className="stats-container sm:grid sm:grid-cols-3 text-center py-7 mx-12">
      <div className="m-auto">
        ...
        alt=""
        className="m-auto"/>
         <h3 className="font-sans font-thin italic text-xl text-blue-400 m-auto">Long term sustained 
        improvement</h3>
        <p className="text-base font-sans italic font-thin text-black w-72 m-auto">
      ...
      <Image src={"/static/images/Heart.png"}
        ...
        height={181.09}
        alt=""
        className="m-auto"/> <h3 className="font-sans font-thin italic text-xl text-blue-400 m-auto">Improvements in the <br></br>burden of disease
        </h3>
        <p className="text-base font-sans italic font-thin text-black w-72 m-auto">
